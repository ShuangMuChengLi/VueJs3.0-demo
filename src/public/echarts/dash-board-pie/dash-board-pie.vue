  ...
  methods: {
    ...
    initMyChartPie(){
      ...
      /*
          ...
          * */
      let id, realTimeValue, value, maxvalue, minvalue;
      ...
      id = this.param.id || 'echartsPie';
      let myChart = echarts.init(document.getElementById(id));
      value = 0;
      realTimeValue = Number(this.param.realTimeValue);
      value = realTimeValue;
      let color1 = this.param.color1 || '#1d54f7';
      let color2 = this.param.color2 || '#00cefc';
      let colorStops = [
        {
          offset: 0,
